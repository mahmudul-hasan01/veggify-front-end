...
const Banner = () => {
    return (
        <div className='px-5 md:w-3/4 lg:w-4/6'>
            <h1 className='mb-10 text-5xl xl:text-6xl text-center font-bold leading-normal xl:leading-relaxed'>A blog template made for food influencers</h1>
