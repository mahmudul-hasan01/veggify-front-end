                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5'>
                        {
                            blogData?.map((blog, index) => (
                                <div key={index} className="w-[280px] h-[350px] relative flex flex-col space-y-4 rounded-lg bg-white shadow-lg hover:scale-105 hover:shadow-2xl transition duration-700 cursor-pointer">
